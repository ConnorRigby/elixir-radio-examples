...
//*********************************************************************************************
#define NODEID        3    // keep UNIQUE for each node on same network
...
void loop() {
  ...
  if (Serial.available() > 0)
  {
    ...
    // if (input == '\r') {}
    // else if (input == '\n') {
    //   radio.sendWithRetry(GATEWAYID, buffer, bufferSize);
    //   bufferSize = 0;
    ...
    //   radio.readAllRegs();
    // if (input == 'A') 
    //   radio.sendWithRetry(GATEWAYID, "a", 1);
    // if (input == 'a') 
    //   radio.send(nodeid++, "abcdef", 6, false);
    // if (input == 'b') {
    ...
    //   Serial.println();
    //   Serial.println(radio.readReg((REG_OPMODE & 0xE3) | RF_OPMODE_STANDBY), HEX);
    //   Serial.println(radio.readReg((REG_OPMODE & 0xE3) | RF_OPMODE_STANDBY), BIN);

    //   Serial.println();
    //   Serial.println(radio.readReg((REG_OPMODE & 0xE3) | RF_OPMODE_RECEIVER), HEX);
    //   Serial.println(radio.readReg((REG_OPMODE & 0xE3) | RF_OPMODE_RECEIVER), BIN);
    // }
  ...
  // Serial.println("doing radio recv");
